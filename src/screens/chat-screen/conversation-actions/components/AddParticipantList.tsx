  ...
  return (
    <Pressable
      ...
      <Animated.View style={tailwind.style('flex flex-row items-center ml-3')}>
        ...
        <Animated.View
          style={tailwind.style('flex-1 py-[11px] ml-2 border-b-[1px] border-blackA-A3 dark:border-whiteA-A3')}>
          <Animated.Text
...
const ParticipantOverflowCell = ({ count }: { count: number }) => {
  return (
    <Pressable style={({ pressed }) => [tailwind.style(pressed ? 'bg-gray-100 dark:bg-grayDark-100' : '')]}>
      <Animated.View style={tailwind.style('flex flex-row items-center ml-3')}>
        <Animated.View>
          <Icon icon={<Overflow stroke={tailwind.color('gray-600') ?? '#6b7280'} />} size={28} />
        </Animated.View>
        <Animated.View
          style={tailwind.style('flex-1 py-[11px] ml-2 border-b-[1px] border-blackA-A3 dark:border-whiteA-A3')}>
          <Animated.Text
        ...
        <Pressable
          ...
          <Animated.View style={tailwind.style('flex flex-row items-center ml-3')}>
            ...
            <Animated.View style={tailwind.style('flex-1 py-[11px] ml-2')}>
              <Animated.Text
                style={tailwind.style(
                  'text-base font-inter-420-20 leading-[22px] tracking-[0.16px] text-brand-primary dark:text-brand-primary-dark',
                )}>
