...
export const InboxItemComponent = (props: InboxItemProps) => {
  ...
  return (
    <Animated.View style={tailwind.style('ml-3 py-3 pr-4 border-b-[1px] border-blackA-A3 dark:border-whiteA-A3')}>
      ...
      {isRead && (
        <Animated.View style={tailwind.style('absolute opacity-50 inset-0 z-20')} />
      )}
    </Animated.View>
  );
};
